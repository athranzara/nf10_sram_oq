/*****************************************************************************
* Filename:          /local/scratch/jz377/Dropbox/nf10_sram_oq/drivers/nf10_sram_output_queue_v1_00_a/src/nf10_sram_output_queue.h
* Version:           1.00.a
* Description:       nf10_sram_output_queue () Driver Header File
* Date:              Fri Dec 12 15:40:15 2014 (by Create and Import Peripheral Wizard)
*****************************************************************************/

#ifndef NF10_SRAM_OUTPUT_QUEUE_H
#define NF10_SRAM_OUTPUT_QUEUE_H
...
*    example code (nf10_sram_output_queue_selftest.c) for details.
*/

#define  nf10_sram_output_queue(\
		 input_slot_id,\
		 output_slot_id,\
		 input_0,      \
		 output_0       \
...
XStatus NF10_SRAM_OUTPUT_QUEUE_SelfTest();
